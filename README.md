...
1. SINGLE RESPONSIBILITY PRINCIPLE - Each class should have only one sole purpose,
...
4. INTERFACE SEGREGATION PRINCIPLE - Interfaces should not force classes to implement what they can’t do.
